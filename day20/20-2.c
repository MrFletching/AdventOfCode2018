...
int count_dist_at_least_1000(Grid *grid) {
...
int main() {
    ...
    int room_count = count_dist_at_least_1000(&grid);
    
    printf("Rooms at least 1000 doors away: %d\n", room_count);
